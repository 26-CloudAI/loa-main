...
보스전은 **유저 봇 1~3개**가 AI 보스 1개에 도전하는 특수 게임 모드다.  
보스는 세 가지 난이도(하/중/상)로 운영되며, **상 난이도 보스는 유저들의 봇 코드를 학습해 점점 강해진다.**
...
- **보스는 너프하지 않음**: 강한 보스를 유저가 전략으로 이기는 구조

### 보스전 게임 구성 (배틀로얄과 다른 점)

| 항목 | 배틀로얄 | 보스전 |
|------|---------|--------|
| 참가 봇 수 | 4~100 | 유저봇 1~3 + 보스 1 |
| max_ticks | 200 | **400** |
| 광물 수 | 300 | **400** |
| 희귀 군락 | 5 | **6** |
| 자유 탐색 구간 | 0~75틱 | **0~150틱** |
| zone 수축 | 76~200틱 | **151~400틱 (느리게)** |
| 최종 안전구역 | 15×15 | **27×27** |

> `boss_battle_config()`가 보스전 전용 설정을 반환.  
> `DEFAULT_CONFIG`(배틀로얄)는 불변 — 보스전 설정은 지역 오버라이드.
